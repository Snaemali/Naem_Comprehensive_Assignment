...
public class assesment_4_MakeMyTripAutomation {

    //  WebDriver Initialization
    public static WebDriver initializeDriver() {
        System.setProperty("webdriver.chrome.driver", "D:\\Projects\\Naem_Comprehensive_Assignment\\drivers\\chromedriver.exe"); // Specify path to chromedriver
    ...
    public static void clickElementByXPath(WebDriver driver, String xpath) {
        ...
        assertTrue(flag, "Element is displayed for click")
        element.click();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean flightobject = flightsXpath.isdisplayed;
            assertTrue(flightobject, "flightobject is displayed for click")
